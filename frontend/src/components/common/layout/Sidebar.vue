...
import HistoryFilter, { type FilterCondition } from '../filter/HistoryFilter.vue'
import HistorySort, { type SortCondition } from '../filter/HistorySort.vue'
    ...
    <div class="info-panel">
      <div class="info-content">
        ...
        <template v-else>
          ...
          <button class="btn-logout btn-collapsed" title="退出登录" @click="handleLogout">
            <svg
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
